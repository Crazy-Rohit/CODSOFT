...
for operation in operations:
    button = tk.Button(frame, text=operation, command=lambda op=operation: calculate(op), bg="pink", font=("Arial", 16))
...
""" Calculate Button
calculate_button = tk.Button(frame, text="Calculate", command=lambda: calculate(""), bg="light blue", font=("Arial", 16))
calculate_button.grid(row=row_num, column=0, columnspan=2, padx=5, pady=5, sticky="nsew")
"""
# Result Label
